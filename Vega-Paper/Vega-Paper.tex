...
This paper follows Schneider \cite{Schn}, who refers to them as absorption properties.
...
The following theorems for $\Event$ are common to all temporal logic systems.
