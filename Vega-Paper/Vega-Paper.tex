...
The $\Event\Always$ axiom states that $\Event\Always p$ ensures that $p$ will always eventually hold, but not the converse.
...
(\ref{E:defWait}) is the only axiom for the \textit{wait} operator.
