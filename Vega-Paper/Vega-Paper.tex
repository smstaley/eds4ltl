...
\hspace{\mymathindent} \= $= \;$ \= \myqedtab \= \kill
  ...
  \> \>   $\neg\Next p \equiv \Next\neg p$
\end{tabbing}
which is (\ref{E:selfDual}), Self-dual. \quad \myqed\\[\lgap]
...
\hspace{\mymathindent} \= $= \;$ \= \myqedtab \= \kill
  ...
  \> \>   $\Always p \equiv \neg\Event\neg p$
\end{tabbing}
which is (\ref{E:defAlways}) Definition of $\Always$. \quad \myqed\\[\lgap]
...
\hspace{\mymathindent} \= $= \;$ \= \myqedtab \= \kill
  ...
  \> \>   $\Event p \lor \neg\Event p$
\end{tabbing}
which is (3.28) Excluded middle, $p\lor\neg p$ with $p := \Event p$. \quad \myqed\\[\lgap]
...
\end{tabbing}
which is (3.5) Reflexivity of $\equiv$, $p\equiv p$. \quad \myqed\\[\lgap]
...
By (3.73) Left identity of $\impl$, $true\impl p\equiv p$, we have $P$. \quad \myqed
...
By (3.73) Left identity of $\impl$, $true\impl p\equiv p$, we have $\Event P\impl\Event Q$. \quad \myqed
...
By (3.73) Left identity of $\impl$, $true\impl p\equiv p$, we have $\Always P\impl\Always Q$. \quad \myqed\\
}
...
\end{tabbing}
which is (\ref{E:axiomUntilImpl}) $\Until$ implication. \quad \myqed \\[\lgap]
