...
\emph{Proof}: By (3.65) Shunting, prove the following equivalent expression: $\Always p \land \Next q \impl \Next (p \land q)$
\begin{tabbing}
\hspace{\mymathindent} \= $= \;$ \= \myqedtab \= \kill
...
\emph{Proof}: By (3.65) Shunting, prove the following equivalent expression: $\Always p \land \Event q \impl \Event (p \land q)$
\begin{tabbing}
\hspace{\mymathindent} \= $= \;$ \= \myqedtab \= \kill
...
\emph{Proof}: By (3.65) Shunting, prove the following equivalent expression: $\Always p \land \Always q \impl \Always (p \land q)$
\begin{tabbing}
\hspace{\mymathindent} \= $= \;$ \= \myqedtab \= \kill
...
\emph{Proof}: *** to be added after location decision ***
\begin{tabbing}
\hspace{\mymathindent} \= $= \;$ \= \myqedtab \= \kill
  \> \>   $\Always (p \equiv q) $\\[\lgap]
  \> $\impl$  \>  \Hint{(\ref{E:impAlwaysN}) Strengthening of $\Always$, with $p:=(p \equiv q)$ }\\[\lgap]
