...
Kröger and Merz \cite{Kroger} first define a \textit{propositional linear temporal logic} consisting of only the unary temporal operators $\Next$ and $\Always$.
...
The \textit{until} operator (denoted \textbf{unt}) and the \textit{wait} operator (denoted \textbf{unl}) are introduced as an extension to the propositional linear temporal logic.
