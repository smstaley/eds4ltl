...
and the distributivity axioms are required to prove the theorems where $\Always\Event$ and $\Event\Always$ distribute over $\equiv$.
The absorption axiom is apparently unique to this system.
