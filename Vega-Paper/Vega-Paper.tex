...
Theorems (\ref{E:excludedMid}) and (\ref{E:excludedMidb}) are the linear temporal versions of the excluded middle axiom of propositional logic.
Theorems (\ref{E:contradiction}) and (\ref{E:contradiction}) are the linear temporal versions of the contraction theorem of propositional logic.
