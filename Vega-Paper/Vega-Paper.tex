...
We avoid adding another operator to our system by restricting the LTL binary operators to the more common $\Until$ and $\Wait$.
...
The proof of (\ref{E:nextFalse}) uses (3.8) Definition of $false$.
...
The proofs of (\ref{E:pUntilQAndNotQUntilP}) and (\ref{E:pUntilQAndNotQUntilP}) use (\ref{E:untilImplicationOrdering}) $\Until$ implication ordering.
...
The proof of (\ref{E:untilIdemR}) is similar to that of (\ref{E:untilIdem}).
