...
\end{tabbing}
which is (\ref{E:nextTruth}) Truth of $\Next$. \myqed\\[\lgap]
}
...
\hspace{\mymathindent} \= $= \;$ \= \kill
  ...
  \> \>   $\Always p \equiv \neg\Event\neg p$
\end{tabbing}
which is (\ref{E:defAlways}) Definition of $\Always$. \myqed\\[\lgap]
...
\end{tabbing}
which is (\ref{E:eventTrue}) Truth of $\Event$. \myqed\\[\lgap]
}
