...
The distributivity of next over until implies the distributivity of next over wait as Section (3.5) shows.
...
\emph{Proof:}\\
Proof by Mutual Implication (3.80) $(p\impl q) \land (q\impl p) \equivs (p\equiv q)$.\\
