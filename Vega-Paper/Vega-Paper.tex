...
LADM defines the dual $P_D$ of a boolean expression $P$ to be the expression constructed from $P$ by interchanging occurrences of
\begin{align*}
...
This observation is stated in the following metatheorem from LADM. \cite{LADM}
\begin{tabbing}
...
but the following proof is uses (\ref{E:linearity}) Linearity instead of duality.
