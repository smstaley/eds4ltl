...
In a proof hint, numeric references that contain a decimal point, such as (3.76a) above, refer to a theorem in $\mathcal{E}$ from Gries and Schneider \cite{LADM}.
