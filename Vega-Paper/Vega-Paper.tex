...
Linear temporal systems \cite{prior} model time as an anchored sequence.
...
The Dummett formula
\begin{equation*}
\Always(\Always(p\impl\Always p)\impl p) \impl (\Event\Always p\impl\Always p)
\end{equation*}
\noindent imposes discreteness of the time line. \cite{Kroger}
...
Of the axioms, six are theorems unique to this system, namely
(\ref{E:untilFalse}),
