...
Theorem (\ref{E:absUntilIntoEvent}) shows also that the binary operator \textit{until} absorbs into the unary operator \textit{eventually}.
It is proved by mutual implication.
