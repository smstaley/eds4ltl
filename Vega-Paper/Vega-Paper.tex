...
\emph{Proof}: Theorem (\ref{E:leftMonoWait}) Left monotonicity of $\Wait$ with $p,q := p \Until q, p\Wait q$ is
\begin{tabbing}
\hspace{\mymathindent} \= $= \;$ \= \myqedtab \= \kill
\> \> $\Always (p \Until q \impl p\Wait q) \impl ((p \Until q) \Wait r \impl (p \Wait q) \Wait r)$
\end{tabbing}
Because the consequent is the theorem to be proved, it suffices to prove the truth of the antecedent.
\begin{tabbing}
\hspace{\mymathindent} \= $= \;$ \= \myqedtab \= \kill
  \> \>   $\Always (p \Until q \impl p\Wait q)$\\[\lgap]
  \> $=$  \>  \Hint{(\ref{E:untilImplWait}) $\Until$ implication}\\[\lgap]
  \> \>   $\Always true$\\[\lgap]
  \> $=$ \> \Hint{(\ref{E:alwaysTrue}) Truth of $\Always$} \\[\lgap]
  \> \>   $true$ \quad \myqed
\end{tabbing}
...
\emph{Proof}: Theorem (\ref{E:rightMonoWait}) Right monotonicity of $\Wait$ with $p,q,r := q \Until r, q\Wait r,p$ is
\begin{tabbing}
\hspace{\mymathindent} \= $= \;$ \= \myqedtab \= \kill
\> \> $\Always (q \Until r \impl q\Wait r) \impl (p\Wait (q\Until r)\impl p\Wait (q\Wait r))$
\end{tabbing}
Because the consequent is the theorem to be proved, it suffices to prove the truth of the antecedent.
\begin{tabbing}
\hspace{\mymathindent} \= $= \;$ \= \myqedtab \= \kill
...
\emph{Proof}: Theorem (\ref{E:rightMonoUntil}) Right monotonicity of $\Until$ with $p,q,r := q \Until r, q\Wait r,p$ is
\begin{tabbing}
\hspace{\mymathindent} \= $= \;$ \= \myqedtab \= \kill
\> \> $\Always (q \Until r \impl q\Wait r) \impl (p\Until (q\Until r)\impl p\Until (q\Wait r))$
\end{tabbing}
Because the consequent is the theorem to be proved, it suffices to prove the truth of the antecedent.
\begin{tabbing}
\hspace{\mymathindent} \= $= \;$ \= \myqedtab \= \kill
...
\emph{Proof}: Theorem (\ref{E:leftMonoUntil}) Left monotonicity of $\Until$ with $p,q := p \Until q, p\Wait q$ is
\begin{tabbing}
\hspace{\mymathindent} \= $= \;$ \= \myqedtab \= \kill
\> \> $\Always (p \Until q \impl p\Wait q) \impl ((p \Until q) \Until r \impl (p \Wait q) \Until r)$
\end{tabbing}
Because the consequent is the theorem to be proved, it suffices to prove the truth of the antecedent.
\begin{tabbing}
\hspace{\mymathindent} \= $= \;$ \= \myqedtab \= \kill
