...
\begin{tabular}{c|cccccccc}
  ...
  $(p\Until q)\Until r$     & F     & T     & T     & T     & T     &  \dots\\[\lgap]
\end{tabular}\\
...
\hspace{\mymathindent} \= $= \;$ \= \kill
	...
	\> \>   $\quad \quad \land \; (\all i \dr j\le i < k \rb (\sigma, i) \models p)\;)$\\[\lgap]
\end{tabbing}
...
\put(0,40) {\line(1,0){140}}
\put(94,33) {$(\sigma,m)\models q$}
\put(94,26) {$k\le m < n$}
\put(70,30) {\line(1,0){60}}
\put(10,20) {\line(1,0){60}}
\end{picture}

\textit{Figure to be completed}\\

\textit{Proof to be completed}\\
...
The following two axioms are absorption laws for the $\Until$ operator.
