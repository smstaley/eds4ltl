...
The proof of (\ref{E:axiomAlwaysUntilImpl}) uses metatheorem (\ref{E:metatheorem}).
The strengthening and ordering theorems are also unique to this system.
We give the proof of (\ref{E:axiomAlwaysUntilImpl}) to show the use of metatheorem (\ref{E:metatheorem}).
