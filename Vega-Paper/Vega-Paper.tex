...
and the $\Always\Until$ axiom is required to prove absorption of $\Until$ into $\Always$.
The axioms (\ref{E:distAlwaysEventOrAx}) and (\ref{E:distEventAlwaysAndAx}) are required to prove the distributivity of $\Always\Event$  over $\lor$ and $\Event\Always$ over $\land$.
...
\textbf{Axiom:}\quad \Always\Event(p \lor q) \impl \Always\Event p \lor \Always\Event q
\end{equation}
