...
\maketitle
\begin{abstract}
This paper surveys the linear temporal logic (LTL) literature and presents all the LTL theorems from the survey, plus many new and interesting ones, in an equational deductive system.
