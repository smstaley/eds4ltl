...
The absorption axiom and the $\Until$ implication axiom are apparently unique to this system.
...
\> $=$ \> \Hint{(\ref{E:defWait}) Definition of $\Wait$} \\[\lgap]
\> \> $\Always p\lor p \Until (p \Wait q)$\\[\lgap]
\> $=$ \> \Hint{(\ref{E:leftUntilAbsWait}) Absorption} \\[\lgap]
\> \> $\Always p\lor p \Wait q$\\[\lgap]
\> $=$ \> \Hint{(\ref{E:defWait}) Definition of $\Wait$} \\[\lgap]
\> \> $\Always p \lor \Always p\lor p \Wait q$\\[\lgap]
