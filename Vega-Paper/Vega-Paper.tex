...
%\documentclass[12pt, fleqn, leqno]{article}                         % For Warford
\documentclass[format=acmsmall, review=false, screen=true]{acmart}   % For submission to ACM Computing Reviews
