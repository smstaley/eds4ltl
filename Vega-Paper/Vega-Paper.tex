...
The distributivity axioms are required to prove the theorems where $\Always\Event$ and $\Event\Always$ distribute over $\equiv$.
...
It presents 40 new linear temporal logic theorems, namely the three axioms
