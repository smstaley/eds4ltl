...
\end{tabular}\\[\lllgap]
State $s_1$ in the last two rows of the above table shows that $(p\Until q)\Until r$ does not imply $p\Until (q\Until r)$, and state $s_6$ shows that $p\Until (q\Until r)$ does not imply $(p\Until q)\Until r$.
