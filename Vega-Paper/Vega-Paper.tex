...
Theorem (\ref{E:nextFalse}) follows from (\ref{E:nextTruth}) by  duality,
but an alternate proof is possible that uses (\ref{E:linearity}) Linearity instead of duality.
...
to (\ref{E:absEventIntoAnd}) the absorption of $\Event$ into $\land$.
