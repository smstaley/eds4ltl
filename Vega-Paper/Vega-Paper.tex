...
Two axioms characterize the \textit{wait} operator, the definition of $\Wait$ in terms of $\Until$ and axiom (\ref{E:axRightWaitAndDist}),
which is necessary to prove the right distributivity of
$\Wait$ over $\land$.
...
\begin{equation}\label{E:axRightWaitAndDist}
\textbf{Axiom:}\quad p \Wait r \land q \Wait r \impl (p \land q) \Wait r
\end{equation}
...
Axiom (\ref{E:axRightWaitAndDist}) supplies the proof in the second direction.
\hfill \myqed\\[\lgap]
