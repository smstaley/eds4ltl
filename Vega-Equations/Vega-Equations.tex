...
\begin{equation}\label{E:benAri1334}
\textbf{Ben-Ari (13.34):}\quad \Event\Always p \land\Always\Event q \impl \Always\Event(p\land q) \quad [\textit{Not yet proved.}]
\end{equation}

\spacer

\begin{equation}\label{E:benAriP260a}
\textbf{Ben-Ari, p. 260a:}\quad \neg(p \Wait q) \equiv (p\land\neg q)\Until (\neg p\land \neg q) \quad [\textit{Not yet proved.}]
\end{equation}

\spacer

\begin{equation}\label{E:benAriP260b}
\textbf{Ben-Ari, p. 260b:}\quad \neg(p \Until q) \equiv (p\land\neg q)\Wait (\neg p\land \neg q) \quad [\textit{Not yet proved.}]
\end{equation}

\spacer

\begin{equation}\label{E:PrProofRule}
\textbf{Progress proof rule:}\quad \Event\Always p \land (\Always p \impl \Event q) \impl \Event q \quad [\textit{Counterexample}]
\end{equation}
