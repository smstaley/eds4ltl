...
\textbf{Absorption:}\quad p \Wait (p \Until q) \equiv p \Wait q \quad [\textit{Conjectured theorem. Not yet proved.}]
\end{equation}

\spacer

\begin{equation}\label{E:rightWaitAbsUtil}
\textbf{Absorption:}\quad (p \Until q) \Wait q \equiv p \Until q \quad [\textit{Conjectured theorem. Not yet proved.}]
\end{equation}
...
\textbf{Left distributivity of $\Wait$ over $\lor$:}\quad p \Wait (q \lor r) \equiv (p \Wait q) \lor (p \Wait r) \quad [\textit{Not yet proved.}]
\end{equation}
...
\textbf{Left distributivity of $\Wait$ over $\land$:}\quad p \Wait (q \land r) \impl (p \Wait q) \land (p \Wait r) \quad [\textit{Not yet proved.}]
\end{equation}
