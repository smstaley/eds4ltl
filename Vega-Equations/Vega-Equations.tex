...
\end{equation}
\opt{inventory}{M222(Rule GEN), M223(Rule SPEC), S61(3.11 Generalization)\\}
...
\end{equation}
\opt{inventory}{M217(FX7), S65(3.27a)\\}
...
\end{equation}
\opt{inventory}{M206(FE4), M217(FX6), S65(3.27b)\\}
...
\end{equation}
\opt{inventory}{M210(FD5), M266(T32), S66(3.33d)\\}
...
\end{equation}
\opt{inventory}{M210(FD6), M266(T31), S66(3.33c)\\}
...
\end{equation}
\opt{inventory}{M207(FI3), M266(T34), S66(3.32b)\\}
...
\end{equation}
\opt{inventory}{M207(FI4), M266(T33), S66(3.32a)\\}
