...
\textbf{Absorption:}\quad (p \Wait q) \Until q \equiv p \Until q \quad [Not\; yet\; proved.]
\end{equation}
...
\textbf{Absorption:}\quad p \Wait (q \Wait r) \impl (p \lor q) \Wait r \quad [Not\; yet\; proved.]
\end{equation}

\spacer

\begin{equation}\label{E:waitOrderingThree}
\textbf{Ordering:}\quad p \Wait (q \land r) \impl (p \Wait q) \Wait r \quad [Not\; yet\; proved.]
\end{equation}
