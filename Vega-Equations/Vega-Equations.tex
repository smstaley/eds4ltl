...
\end{equation}
\opt{inventory}{M206(FU3), M208, S64(3.21a), K27(T1), E7, B239\\}
...
\end{equation}
\opt{inventory}{M208, M264(T2), S65(3.22b), K29(T16), E8, B242, B265()\\}
...
\end{equation}
\opt{inventory}{M264(Rule $\Always$I), S65(3.24b)\\}
...
\end{equation}
\opt{inventory}{M264(Rule $\Event$I), Note: This rule is modified as rule in text is not a theorem. 
A counterexample to the rule in the text is $p = (T F T)$ and $q = (T F F)$.\\}
...
\textbf{Right strengthening of $\Until$:}\quad p\Until(q \land r) \impl p\Until(q\Until r)
\end{equation}

\spacer

\begin{equation}\label{E:andUntilImplUntilUntil}
\textbf{Left strengthening of $\Until$:}\quad (p \land q) \Until r \impl (p\Until q)\Until r
\end{equation}
...
\end{equation}
\opt{inventory}{M208, S66(3.33b), K73(Tb19)\\}
...
\end{equation}
\opt{inventory}{Inspired by S66(3.36)\\}
...
\textbf{Absorption:}\quad p \Wait (q \Wait r) \impl p \Wait (q \lor r)
\end{equation}
...
\end{equation}
\opt{inventory}{M266(T35), (A closer look here is needed.), S66(3.34b)\\}
