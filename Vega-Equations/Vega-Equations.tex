...
\end{equation}
\opt{inventory}{M209, M217(FX2), S64(3.21b), K29(T14), E8, B242\\}
...
\end{equation}
\opt{inventory}{B239(T13.25), B241(T13.31)\\}
...
\end{equation}
\opt{inventory}{M217(FX5), S64(3.21e), B242\\}
...
\end{equation}
\opt{inventory}{M217(FX3), S61(3.10b), K29(T22), E9, B242, B237(T13.15)\\}
...
\textbf{Ben-Ari equivalence:}\quad \Always (\Always\Event p \impl \Event q) \equiv (\Always\Event q \lor \Event\Always\neg p)
\end{equation}
...
\textbf{Emerson equivalence of $\Wait$:}\quad p \Wait q  \equiv \Always (p \land \neg q) \lor p \Until q
\end{equation}
\opt{inventory}{E9\\}
