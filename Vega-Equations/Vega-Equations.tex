...
% Broken in MacOS High Sierra. See https://tex.stackexchange.com/questions/395645/italic-went-rogue-in-my-document-what-happened
...
\textbf{Lemmon:}\quad \Always(\Always p\impl q)\lor \Always(\Always q\impl p)
\end{equation}
