...
\end{equation}
\opt{inventory}{M206(FU3), M208, S64(3.21a), K27(T1)\\}
...
\end{equation}
\opt{inventory}{M209, M217(FX2), S64(3.21b), K29(T14)\\}
...
\end{equation}
\opt{inventory}{M208, M264(T2), S65(3.22b), K29(T16)\\}
...
\end{equation}
\opt{inventory}{M208, M264(T1), S65(3.22a), K29(T15)\\}
...
\end{equation}
\opt{inventory}{M206(FE3), K67(Tb4), K70(Tb13)\\}
...
\end{equation}
\opt{inventory}{M206(FE2), M264(T13), S65(3.26), K30(T29)\\}
...
\end{equation}
\opt{inventory}{M205(FR6), M264(T10), S63(3.16c), K28(T5)\\}
...
\end{equation}
\opt{inventory}{M207(FI2), M264(T11), S63(3.18b), K28(T11)\\}
...
\end{equation}
\opt{inventory}{M208, S65(3.22d), K28(T13)\\}
...
\end{equation}
\opt{inventory}{M210(FD2), M264(T12), S63(3.17b), K29(T19)\\}
...
\end{equation}
\opt{inventory}{S63(3.17a), K29(T25)\\}
...
\end{equation}
\opt{inventory}{S63(3.16e), K28(T9)\\}
...
\end{equation}
\opt{inventory}{M206(FU1), S63(3.16b), K27(T2)\\}
...
\end{equation}
\opt{inventory}{M206(FU1), S63(3.16a), K28(T3)\\}
...
\end{equation}
\opt{inventory}{M206(FE1), M264(T3), S65(3.25), K30(T28)\\}
...
\end{equation}
\opt{inventory}{M207(FI1), M264(T7), S63(3.18a), K28(T10)\\}
...
\end{equation}
\opt{inventory}{M208, S65(3.22c), K28(T12)\\}
...
\end{equation}
\opt{inventory}{M205, M217(FX0), M264(T4), S61(3.10a), K28(T4)\\}
...
\end{equation}
\opt{inventory}{S63(3.16d), K28(T8)\\}
...
\end{equation}
\opt{inventory}{M264(T6), S64(3.21c), K28(T6)\\}
...
\end{equation}
\opt{inventory}{M217(FX4), M264(T5), S64(3.21d)\\}
...
\end{equation}
\opt{inventory}{M210(FD1), M264(T9), S62(3.12a), K29(T18)\\}
...
\end{equation}
\opt{inventory}{S62(3.12b), K29(T23)\\}
...
\end{equation}
\opt{inventory}{S65(3.22f), K30(T30)\\}
...
\end{equation}
\opt{inventory}{S63(3.16f), K30(T31)\\}
...
\end{equation}
\opt{inventory}{M217(FX3), S61(3.10b), K29(T22)\\}
...
\end{equation}
\opt{inventory}{S63(3.17c), K29(T26)\\}
...
\end{equation}
\opt{inventory}{S63(3.17f), K29(T27)\\}
...
\end{equation}
\opt{inventory}{M211(FD9), S63(3.17d), K29(T20)\\}
...
\end{equation}
\opt{inventory}{M211(FD10), S63(3.17e), K29(T21)\\}
...
\end{equation}
\opt{inventory}{M208(FA1), S63(3.18d), K32(T37)\\}
...
\end{equation}
\opt{inventory}{M208(FA2), S63(3.18c), K33(T38)\\}
...
\end{equation}
\opt{inventory}{M206(FWS1), K67(Tb3)\\}
