...
\end{equation}
\opt{inventory}{K27, M206(FU3), M208, S64(3.21a)\\}
...
\end{equation}
\opt{inventory}{M209, M217(FX2), S64(3.21b)\\}
...
\end{equation}
\opt{inventory}{M208, M264(T2), S65(3.22b)\\}
...
\end{equation}
\opt{inventory}{M208, M264(T1), S65(3.22a)\\}
...
\end{equation}
\opt{inventory}{M206(FE2), M264(T13), S65(3.26)\\}
...
\end{equation}
\opt{inventory}{M205(FR6), M264(T10), S63(3.16c)\\}
...
\end{equation}
\opt{inventory}{M207(FI2), M264(T11), S63(3.18b)\\}
...
\end{equation}
\opt{inventory}{M210(FD2), M264(T12), S63(3.17b)\\}
...
\Event p \equiv \neg\Always\neg p
\end{equation}
\opt{inventory}{M199, M217, S62(3.15)\\}
...
\end{equation}
\opt{inventory}{K27, M206(FU1), S63(3.16b)\\}
...
\end{equation}
\opt{inventory}{M206(FU1), S63(3.16a)\\}
...
\end{equation}
\opt{inventory}{M206(FE1), M264(T3), S65(3.25)\\}
...
\end{equation}
\opt{inventory}{M207(FI1), M264(T7), S63(3.18a)\\}
...
\end{equation}
\opt{inventory}{M205, M217(FX0), M264(T4), S61(3.10a)\\}
...
\end{equation}
\opt{inventory}{M264(T6), S64(3.21c)\\}
...
\end{equation}
\opt{inventory}{M210(FD1), M264(T9), S62(3.12a)\\}
...
\end{equation}
\opt{inventory}{M217(FX3), S61(3.10b)\\}
...
\end{equation}
\opt{inventory}{M211(FD9), S63(3.17d)\\}
...
\end{equation}
\opt{inventory}{M211(FD10), S63(3.17e)\\}
...
\end{equation}
\opt{inventory}{M208(FA1), S63(3.18d)\\}
...
\end{equation}
\opt{inventory}{M208(FA2), S63(3.18c)\\}
