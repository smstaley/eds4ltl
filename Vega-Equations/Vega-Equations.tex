...
\end{equation}
\opt{inventory}{K27, M206(FU3), M208\\}
...
\end{equation}
\opt{inventory}{M206(FE2), M264(T13)\\}
...
\end{equation}
\opt{inventory}{M205(FR6), M264(T10)\\}
...
\end{equation}
\opt{inventory}{M207(FI2), M264(T11)\\}
...
\end{equation}
\opt{inventory}{M210(FD2), M264(T12)\\}
...
\end{equation}
\opt{inventory}{M206(FE1), M264(T3)\\}
...
\end{equation}
\opt{inventory}{M207(FI1), M264(T7)\\}
...
\end{equation}
\opt{inventory}{S61, M205, M217(FX0), M264(T4)\\}
...
\end{equation}
\opt{inventory}{M217(FX4), M264(T5)\\}
...
\end{equation}
\opt{inventory}{M210(FD1), M264(T9)\\}
...
\end{equation}
\opt{inventory}{S61 (Generalization), M222(Rule GEN), M223(Rule SPEC)\\}
...
\end{equation}
\opt{inventory}{M206(FE4), M217(FX6)\\}
...
\end{equation}
\opt{inventory}{M210(FD5), M266(T32)\\}
...
\end{equation}
\opt{inventory}{M210(FD6), M266(T31)\\}
...
\end{equation}
\opt{inventory}{M207(FI3), M266(T34)\\}
...
\end{equation}
\opt{inventory}{M207(FI4), M266(T33)\\}
...
\end{equation}
\opt{inventory}{M266(T35), (A closer look here is needed.)\\}
