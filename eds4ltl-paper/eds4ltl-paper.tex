...
\documentclass[format=acmsmall, review=false, screen=true, fleqn]{acmart}

\usepackage[leqno]{amsmath}                         % For equation numbers on the left
\makeatletter
...
\usepackage[publication]{optional}                  % Hide most proofs for publication
%\usepackage[complete]{optional}                    % Typeset all proofs
...
\newcommand{\Next}{\;\,\text{\raisebox{2.5pt}{\circle{5}}}}
